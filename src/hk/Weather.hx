...
typedef RhrreadData = {
	...
	mintempFrom00To09:EmptyStringAsNull<Float>,
	rainfallFrom00To12:EmptyStringAsNull<Float>,
	rainfallLastMonth:EmptyStringAsNull<Float>,
	rainfallJanuaryToLastMonth:EmptyStringAsNull<Float>,
	humidity: {
		recordTime:WeatherDate,
